#!/usr/bin/env bash
# Download 20 US States — convenience startup script
#
...
#
# Usage:
#   examples/osm-geocoder/tests/real/scripts/run_osm_cache_states_20.sh
#
set -euo pipefail
...
# ---------------------------------------------------------------------------
echo "=== Compiling osm_cache_states_20.afl ==="
AFL_FILE="$REAL_DIR/ffl/osm_cache_states_20.ffl"
OUTPUT_FILE="$REAL_DIR/osm_cache_states_20.json"
...
# ---------------------------------------------------------------------------
echo "=== Submitting DownloadStates_20 workflow ==="
